...
namespace WindowsFormsApp1
{
    public partial class Страна : Form
    {
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                IDbCommand cmd = new SqlCommand("DELETE FROM Strana WHERE Nomer=@Nomer");
                cmd.Connection = connection;
        ...
        {
            Страна_добавить_изменить n = new Страна_добавить_изменить(0);
            this.Visible = false;
            n.Text = "Добавить";
            n.ShowDialog();
            this.Visible = true;
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            try //Проверка на ошибку, выделена ли строка в таблице
            {
                Страна_добавить_изменить n = new Страна_добавить_изменить(Convert.ToInt32(dataGridView1.Rows[dataGridView1.SelectedRows[0].Index].Cells[0].Value));
                this.Visible = false;
                n.Text = "Изменить";
                n.ShowDialog();
                this.Visible = true;
